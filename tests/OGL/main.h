...
#define SCREEN_W	800										// Screen Width Of Our App Is 640 Points
#define SCREEN_H	600										// SCreen Height Of Our App Is 480 Points
...
void Update(Uint32, Uint8 *,Posicion_Graf*);								// Update Data
void Desplazar(float, Posicion_Graf*);
void Draw(SDL_Surface *,Posicion_Graf*);
void addPared(float,float,float,float);
void DrawEscenario();
						// Do The Drawings
void Draw2D(SDL_Surface *);									// SDL Drawing routine
void Draw3D(SDL_Surface *,Posicion_Graf*);									// OpenGL Drawing routine
