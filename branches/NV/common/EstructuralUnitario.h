...
class EstructuralUnitario{
	...
	private:
		...
		EstructuralUnitario * arriba;
		EstructuralUnitario * abajo;
		EstructuralUnitario * derecha;
		EstructuralUnitario * izquierda;
	...
	public:
		...
		*/
		void set_arriba(EstructuralUnitario * e);
		void set_abajo(EstructuralUnitario * e);
		void set_derecha(EstructuralUnitario * e);
		void set_izquierda(EstructuralUnitario * e);
		...
		*/
		EstructuralUnitario * get_arriba();
		EstructuralUnitario * get_abajo();
		EstructuralUnitario * get_derecha();
		EstructuralUnitario * get_izquierda();
		...
		*			nulo.		
		*/
		EstructuralUnitario * get_vecino(Direccion &dir);
		...
		*/
		bool tiene_conexion(EstructuralUnitario * e);
	
		/**
		*	@brief	Permite settear una comida al estructural. Elimina el anterior
		*
		*	@param  comestible Comida a agregar
		*/
		virtual void set_comida(Comestible * comestible);
};
